...
const PatientForm = () => {
  ...
  const [isHealthRecordModalOpen, setHealthRecordModalOpen] = React.useState(false);
  ...
  return (
    ...
    <Modal style={{height:'90vh', width:'90%'}} heading="Add Treatment" open={isTreatmentModalOpen} handleClose={closeTreatmentModal}>
        <AddTreatment />
      </Modal>
      <Modal style={{height:'90vh', width:'90%'}} heading="Records" open={isHealthRecordModalOpen} handleClose={closeHealthRecordModal}>
        <HealthRecords />
      </Modal>
      <Modal style={{height:'90vh', width:'90%'}} heading="Lab Reports" open={isHealthRecordModalOpen} handleClose={closeHealthRecordModal}>
        <LabReports />
      </Modal>
    </Fragment>
